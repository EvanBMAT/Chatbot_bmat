! function(t, e) {
    ...
    return function(t) {
        ...
        */
        ...
        (e = t.exports = n(10)(!1)).push([t.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), e.push([t.i, ".conversation-container .message{margin:10px;display:flex;font-size:14px;font-family:Roboto,serif}.conversation-container .message .markdown p{margin:0}.conversation-container .client{background-color:#003a9b;color:#fff;border-radius:10px;padding:15px;max-width:215px;text-align:left;font-family:Roboto,serif;margin-left:auto;overflow-wrap:break-word}.conversation-container .client a{color:#35cce6}.conversation-container .response{background-color:#f4f7f9;color:#000;border-radius:10px;padding:15px;max-width:215px;text-align:left;font-family:Roboto,serif;overflow-wrap:break-word}.conversation-container .message-text{margin:0}.conversation-container .avatar{width:40px;height:40px;border-radius:100%;margin-right:10px}", ""])
    }, function(t, e, n) {
        var r = n(194);
        "string" == typeof r && (r = [
            [t.i, r, ""]
        ...
        (e = t.exports = n(10)(!1)).push([t.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), e.push([t.i, ".conversation-container .header{background-color:#003a9b;color:#fff;display:flex;flex-direction:column;justify-content:center;text-align:center;height:55px;font-family:Roboto,serif}.conversation-container .title{font-size:20px;margin:0;font-family:Roboto,serif}.conversation-container .close-button{display:none}.conversation-container .loading{background-color:#b5b5b5;color:#fff;display:flex;flex-direction:column;text-align:center;padding:5px 0;font-family:Roboto,serif;font-size:14px}.widget-embedded .header{display:none}.full-screen .header{border-radius:0;flex-shrink:0;position:relative}.full-screen .close-button{display:flex;justify-content:center;align-items:center;background-color:#003a9b;border:0;position:absolute;right:10px;width:40px}.full-screen .close{width:30px;height:30px}.full-screen .close.default{width:20px;height:20px}.full-screen .loading{border-radius:0;flex-shrink:0;position:relative}@media screen and (max-width:800px){.conversation-container .header{border-radius:0;flex-shrink:0;position:relative}.conversation-container .close-button{display:flex;justify-content:center;align-items:center;background-color:#003a9b;border:0;position:absolute;right:10px;width:40px}.conversation-container .close{width:30px;height:30px}.conversation-container .close.default{width:20px;height:20px}.conversation-container .loading{border-radius:0;flex-shrink:0;position:relative}}", ""])
    }, function(t, e, n) {
        var r = n(288);
        "string" == typeof r && (r = [
            [t.i, r, ""]
